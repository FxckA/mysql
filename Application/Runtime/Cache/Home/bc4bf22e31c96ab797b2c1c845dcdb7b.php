	...
	<div class="main">
      ...
      <div class="content">
        <div class="con_text">
          <div class="list">
            <ul>
              	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a target="_blank" href="<?php echo U("automake/index?id="); echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a><span>01-21</span></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
          </div>
        </div>
      </div>
