...
<div id="page-wrapper">
	...
	<div class="row">
		<div class="col-md-6">
			<a href="<?php echo U('news/add');?>" class="btn btn-success">添加新闻公告</a>
		</div>
		<div class="col-md-6">
	...
	<table class="table table-hover table-striped">
		...
		<tbody>
			<?php if(is_array($news)): foreach($news as $key=>$v): ?><tr>
					...
					<?php if($v["status"] == 1): ?><td><a href="<?php echo U('news/post?id='); echo ($v["id"]); ?>" style="color:red;">撤销</a> | <a href="<?php echo U('news/update?id='); echo ($v["id"]); ?>">编辑</a> | <a href="<?php echo U('news/delete?id='); echo ($v["id"]); ?>" style="color:red;" onclick="javascript:return del('您真的确定要删除吗？\n\n删除后将不能恢复!');">删除</a></td>
						<?php else: ?>
						<td><a href="<?php echo U('news/post?id='); echo ($v["id"]); ?>" class="label label-success">发布</a> | <a href="<?php echo U('news/update?id='); echo ($v["id"]); ?>">编辑</a> | <a href="<?php echo U('news/delete?id='); echo ($v["id"]); ?>" style="color:red;" onclick="javascript:return del('您真的确定要删除吗？\n\n删除后将不能恢复!');">删除</a></td><?php endif; ?>
