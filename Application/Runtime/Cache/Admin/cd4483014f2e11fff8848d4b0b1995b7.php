...
<div id="page-wrapper">
    ...
    <table class="table table-hover table-striped">
        ...
        <?php if(is_array($member)): foreach($member as $key=>$v): ?><tr>
                ...
                <?php if($v["status"] == 1): ?><td><a href="<?php echo U('member/update?id='); echo ($v["id"]); ?>">编辑</a> | <a href="<?php echo U('member/stop?id='); echo ($v["id"]); ?>" style="color:red;" onclick="javascript:return del('禁用后用户将不能登陆后台!\n\n请确认!!!');">禁用</a></td>
            	<?php else: ?>
            		<td><a href="<?php echo U('member/update?id='); echo ($v["id"]); ?>">编辑</a> | <a href="<?php echo U('member/stop?id='); echo ($v["id"]); ?>" style="color:#50AD1E;">启用</a></td><?php endif; ?>
